...
<head>
    ...
    <link rel="stylesheet" href= "css\phpdiscusion.css">
</head>
<body>
    <h1>Tecnologia</h1>
    <div class="caja1">
...
if(!empty($_POST)){
    ...
    $texto = $_POST['texto'];
    $fecha = date("y/m/d");
    $conexion->query("INSERT INTO `tabla1` (`ID`, `Nickname`, `Comentario`, `Fecha`) VALUES (NULL, '$nombre', '$texto', '$fecha');");
    }
     $busca = $conexion->query("SELECT * FROM `tabla1`");
